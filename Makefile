...
override CFLAGS += -mthumb-interwork -Wimplicit -Wparentheses -Werror -fhex-asm -g
ROM := $(ROM_NAME)
...
override CFLAGS += -mthumb -mthumb-interwork -mabi=apcs-gnu -mtune=arm7tdmi -march=armv4t -fno-toplevel-reorder -Wno-pointer-to-int-cast -g
ROM := $(MODERN_ROM_NAME)
...
compare: ; @echo Silly you, this isn\'t pokeemerald!
