...
extern const u8 gText_PlacesAndPeople[];
extern const u8 gText_LetsAllSing[];
extern const u8 gText_PokeFlute[];
...
extern const u8 gText_PNPDescriptionCute[];
extern const u8 gText_PNPDescriptionLazy[];
extern const u8 gText_PNPDescriptionHappy[];
extern const u8 gText_PNPDescriptionNoisy[];
extern const u8 gText_PNPDescriptionPrecocious[];
extern const u8 gText_PNPDescriptionBold[];
extern const u8 gText_PNPDescriptionPicky[];
extern const u8 gText_PNPDescriptionSortOfOK[];
extern const u8 gText_PNPDescriptionSoSo[];
extern const u8 gText_PNPDescriptionGreat[];
extern const u8 gText_PNPDescriptionMyType[];
extern const u8 gText_PNPDescriptionCool[];
extern const u8 gText_PNPDescriptionInspiring[];
extern const u8 gText_PNPDescriptionWeird[];
extern const u8 gText_PNPDescriptionRightForMe[];
extern const u8 gText_PNPDescriptionOdd[];
extern const u8 gText_PokemonChannel1[];
extern const u8 gText_PokedexShow1[];
extern const u8 gText_PkmnMusicBen1[];
extern const u8 gText_PkmnMusicBen2[];
extern const u8 gText_PkmnMusicBen3[];
extern const u8 gText_PkmnMusicFern1[];
extern const u8 gText_PkmnMusicFern2[];
extern const u8 gText_PkmnMusicBenFern1[];
extern const u8 gText_PkmnMusicBenFern2A[];
extern const u8 gText_PkmnMusicBenFern2B[];
extern const u8 gText_PkmnMusicBenFern3A[];
extern const u8 gText_PkmnMusicBenFern3B[];
extern const u8 gText_LuckyChannel1[];
extern const u8 gText_LuckyChannel2[];
extern const u8 gText_LuckyChannel3[];
extern const u8 gText_LuckyChannel4[];
extern const u8 gText_LuckyChannel5[];
extern const u8 gText_LuckyChannel6[];
extern const u8 gText_LuckyChannel7[];
extern const u8 gText_LuckyChannel8[];
extern const u8 gText_LuckyChannel9[];
extern const u8 gText_LuckyChannel10[];
extern const u8 gText_LuckyChannel11[];
extern const u8 gText_LuckyChannel12[];
extern const u8 gText_LuckyChannel13[];
extern const u8 gText_BuenasPassword1[];
extern const u8 gText_BuenasPassword2[];
extern const u8 gText_BuenasPassword3[];
extern const u8 gText_BuenasPassword4[];
extern const u8 gText_BuenasPassword5[];
extern const u8 gText_BuenasPassword6[];
extern const u8 gText_BuenasPassword7[];
extern const u8 gText_BuenasPassword8[];
extern const u8 gText_BuenasPassword9[];
extern const u8 gText_BuenasPassword10[];
extern const u8 gText_BuenasPassword11[];
extern const u8 gText_BuenasPassword12[];
extern const u8 gText_BuenasPassword13[];
extern const u8 gText_BuenasPassword14[];
extern const u8 gText_BuenasPassword15[];
extern const u8 gText_BuenasPassword16[];
extern const u8 gText_BuenasPassword17[];
extern const u8 gText_PlacesAndPeople1[];
extern const u8 gText_PlacesAndPeople2[];
extern const u8 gText_PlacesAndPeople3[];
extern const u8 gText_PlacesAndPeople4Place[];
extern const u8 gText_PlacesAndPeople4Person[];
...
extern const u8 gText_UpDownPickAOk[];
extern const u8 gText_ANext[];
...
extern const u8 gText_ShortOnFunds[];
extern const u8 gText_HeheheYouDontHaveTheMoney[];
extern const u8 gText_Var1CertainlyHowMany2[];
extern const u8 gText_Var1CertainlyHowMany[];
extern const u8 gText_Var1HeheheOkayHowMany[];
extern const u8 gText_Var1IsItThatllBeVar2[];
extern const u8 gText_YouWantedVar1ThatllBeVar2[];
extern const u8 gText_Var1CostsVar2WantIt[];
extern const u8 gText_InBagVar1[];
extern const u8 gText_Var1AndYouWantedVar2[];
extern const u8 gText_Var1AndVar2OfThem[];
extern const u8 gText_HereYouGoThankYou[];
extern const u8 gText_Thanks[];
extern const u8 gText_ThankYouDearHehehehe[];
extern const u8 gText_NoMoreRoomForThis[];
extern const u8 gText_BagIsChockFull[];
extern const u8 gText_OhYourBagIsFullDear[];
extern const u8 gText_BoughtItemAlready[];
...
extern const u8 gText_DexJohtoTitle[];
...
extern const u8 gText_DexJohtoDescription[];
...
extern const u8 gText_AbraPrizeAndPrice[];
extern const u8 gText_CubonePrizeAndPrice[];
extern const u8 gText_WobbuffetPrizeAndPrice[];
extern const u8 gText_TM25AndPrice[];
extern const u8 gText_TM14AndPrice[];
extern const u8 gText_TM38AndPrice[];
...
extern const u8 gText_PartySelectionEntered[];
...
extern const u8 gText_BattleItemsPocket[];
extern const u8 gText_TreasuresPocket[];
...
extern const u8 gText_RSTrainerCardIDNo[];
...
extern const u8 gText_RSTrainerCardColon[];
extern const u8 gText_RSTrainerCardTime[];
extern const u8 gText_Var1sTrainerCard[];
extern const u8 gText_HallOfFameDebut[];
extern const u8 gText_FirstHallOfFame[];
extern const u8 gText_WinsLosses[];
extern const u8 gText_FRLGWinsLosses[];
...
extern const u8 gText_ContestsWFriends[];
...
//Crystal-Specific MatchCall Text
extern const u8 Matchcall_Alan_Answer_Morn[];
extern const u8 Matchcall_Alan_Answer_Day[];
extern const u8 Matchcall_Alan_Answer_Night[];
extern const u8 Matchcall_Alan_Call[];
extern const u8 Matchcall_Alan_Generic5[];
extern const u8 Matchcall_Alan_Bragging[];
extern const u8 Matchcall_Alan_DefeatedMon[];
extern const u8 Matchcall_Alan_LostMon[];
extern const u8 Matchcall_Alan_Rematch[];
extern const u8 Matchcall_Alan_Hangup[];
extern const u8 Matchcall_Alan_Gift[];
extern const u8 Matchcall_Alan_HangupOutgoing[];
extern const u8 Matchcall_Alan_Remind_Rematch[];
extern const u8 Matchcall_Alan_Remind_Gift[];
extern const u8 Matchcall_Anthony_Answer_Morn[];
extern const u8 Matchcall_Anthony_Answer_Day[];
extern const u8 Matchcall_Anthony_Answer_Night[];
extern const u8 Matchcall_Anthony_Call_Morn[];
extern const u8 Matchcall_Anthony_Call_Day[];
extern const u8 Matchcall_Anthony_Call_Night[];
extern const u8 Matchcall_Anthony_Generic5[];
extern const u8 Matchcall_Anthony_Bragging[];
extern const u8 Matchcall_Anthony_DefeatedMon[];
extern const u8 Matchcall_Anthony_LostMon[];
extern const u8 Matchcall_Anthony_Rematch[];
extern const u8 Matchcall_Anthony_Hangup[];
extern const u8 Matchcall_Anthony_Swarm[];
extern const u8 Matchcall_Anthony_HangupOutgoing[];
extern const u8 Matchcall_Anthony_Remind_Rematch[];
extern const u8 Matchcall_Anthony_Remind_Swarm[];
extern const u8 Matchcall_Arnie_Answer_Morn[];
extern const u8 Matchcall_Arnie_Answer_Day[];
extern const u8 Matchcall_Arnie_Answer_Night[];
extern const u8 Matchcall_Arnie_Call_Morn[];
extern const u8 Matchcall_Arnie_Call_Day[];
extern const u8 Matchcall_Arnie_Call_Night[];
extern const u8 Matchcall_Arnie_Generic5[];
extern const u8 Matchcall_Arnie_Bragging[];
extern const u8 Matchcall_Arnie_DefeatedMon[];
extern const u8 Matchcall_Arnie_LostMon[];
extern const u8 Matchcall_Arnie_Rematch[];
extern const u8 Matchcall_Arnie_Hangup[];
extern const u8 Matchcall_Arnie_Swarm[];
extern const u8 Matchcall_Arnie_HangupOutgoing[];
extern const u8 Matchcall_Arnie_Remind_Rematch[];
extern const u8 Matchcall_Arnie_Remind_Swarm[];
extern const u8 Matchcall_Beth_Answer_Morn[];
extern const u8 Matchcall_Beth_Answer_Day[];
extern const u8 Matchcall_Beth_Answer_Night[];
extern const u8 Matchcall_Beth_Call_Morn[];
extern const u8 Matchcall_Beth_Call_Day[];
extern const u8 Matchcall_Beth_Call_Night[];
extern const u8 Matchcall_Beth_Generic5[];
extern const u8 Matchcall_Beth_Bragging[];
extern const u8 Matchcall_Beth_DefeatedMon[];
extern const u8 Matchcall_Beth_LostMon[];
extern const u8 Matchcall_Beth_Rematch[];
extern const u8 Matchcall_Beth_Hangup[];
extern const u8 Matchcall_Beth_HangupOutgoing[];
extern const u8 Matchcall_Beth_Remind_Rematch[];
extern const u8 Matchcall_Beverly_Answer_Morn[];
extern const u8 Matchcall_Beverly_Answer_Day[];
extern const u8 Matchcall_Beverly_Answer_Night[];
extern const u8 Matchcall_Beverly_Call_Morn[];
extern const u8 Matchcall_Beverly_Call_Day[];
extern const u8 Matchcall_Beverly_Call_Night[];
extern const u8 Matchcall_Beverly_Generic5[];
extern const u8 Matchcall_Beverly_Bragging[];
extern const u8 Matchcall_Beverly_DefeatedMon[];
extern const u8 Matchcall_Beverly_LostMon[];
extern const u8 Matchcall_Beverly_Hangup[];
extern const u8 Matchcall_Beverly_Gift[];
extern const u8 Matchcall_Beverly_HangupOutgoing[];
extern const u8 Matchcall_Beverly_Remind_Gift[];
extern const u8 Matchcall_Brent_Answer[];
extern const u8 Matchcall_Brent_Call[];
extern const u8 Matchcall_Brent_Generic15[];
extern const u8 Matchcall_Brent_Bragging[];
extern const u8 Matchcall_Brent_DefeatedMon[];
extern const u8 Matchcall_Brent_LostMon[];
extern const u8 Matchcall_Brent_Rematch[];
extern const u8 Matchcall_Brent_Hangup[];
extern const u8 Matchcall_Brent_Generic11[];
extern const u8 Matchcall_Brent_Generic10[];
extern const u8 Matchcall_Brent_Generic9[];
extern const u8 Matchcall_Brent_Generic8[];
extern const u8 Matchcall_Brent_Generic7[];
extern const u8 Matchcall_Brent_Generic6[];
extern const u8 Matchcall_Brent_Generic5[];
extern const u8 Matchcall_Brent_Generic4[];
extern const u8 Matchcall_Brent_Generic3[];
extern const u8 Matchcall_Brent_Generic2[];
extern const u8 Matchcall_Brent_HangupOutgoing[];
extern const u8 Matchcall_Brent_Remind_Rematch[];
extern const u8 Matchcall_Chad_Answer_Morn[];
extern const u8 Matchcall_Chad_Answer_Day[];
extern const u8 Matchcall_Chad_Answer_Night[];
extern const u8 Matchcall_Chad_Call_Morn[];
extern const u8 Matchcall_Chad_Call_Day[];
extern const u8 Matchcall_Chad_Call_Night[];
extern const u8 Matchcall_Chad_Generic15[];
extern const u8 Matchcall_Chad_Bragging[];
extern const u8 Matchcall_Chad_DefeatedMon[];
extern const u8 Matchcall_Chad_LostMon[];
extern const u8 Matchcall_Chad_Rematch[];
extern const u8 Matchcall_Chad_Hangup[];
extern const u8 Matchcall_Chad_Generic11[];
extern const u8 Matchcall_Chad_Generic10[];
extern const u8 Matchcall_Chad_Generic9[];
extern const u8 Matchcall_Chad_Generic8[];
extern const u8 Matchcall_Chad_Generic7[];
extern const u8 Matchcall_Chad_Generic6[];
extern const u8 Matchcall_Chad_Generic5[];
extern const u8 Matchcall_Chad_Generic4[];
extern const u8 Matchcall_Chad_Generic3[];
extern const u8 Matchcall_Chad_Generic2[];
extern const u8 Matchcall_Chad_HangupOutgoing[];
extern const u8 Matchcall_Chad_Remind_Rematch[];
extern const u8 Matchcall_Dana_Answer_Morn[];
extern const u8 Matchcall_Dana_Answer_Day[];
extern const u8 Matchcall_Dana_Answer_Night[];
extern const u8 Matchcall_Dana_Call[];
extern const u8 Matchcall_Dana_Generic5[];
extern const u8 Matchcall_Dana_Bragging[];
extern const u8 Matchcall_Dana_DefeatedMon[];
extern const u8 Matchcall_Dana_LostMon[];
extern const u8 Matchcall_Dana_Rematch[];
extern const u8 Matchcall_Dana_Hangup[];
extern const u8 Matchcall_Dana_Gift[];
extern const u8 Matchcall_Dana_HangupOutgoing[];
extern const u8 Matchcall_Dana_Remind_Rematch[];
extern const u8 Matchcall_Dana_Remind_Gift[];
extern const u8 Matchcall_Derek_Answer_Morn[];
extern const u8 Matchcall_Derek_Answer_Day[];
extern const u8 Matchcall_Derek_Answer_Night[];
extern const u8 Matchcall_Derek_Call_Morn[];
extern const u8 Matchcall_Derek_Call_Day[];
extern const u8 Matchcall_Derek_Call_Night[];
extern const u8 Matchcall_Derek_Generic5[];
extern const u8 Matchcall_Derek_Bragging[];
extern const u8 Matchcall_Derek_DefeatedMon[];
extern const u8 Matchcall_Derek_LostMon[];
extern const u8 Matchcall_Derek_Hangup[];
extern const u8 Matchcall_Derek_Bug_Catching_Contest[];
extern const u8 Matchcall_Derek_Gift[];
extern const u8 Matchcall_Derek_HangupOutgoing[];
extern const u8 Matchcall_Derek_Remind_Gift[];
extern const u8 Matchcall_Erin_Answer_Morn[];
extern const u8 Matchcall_Erin_Answer_Day[];
extern const u8 Matchcall_Erin_Answer_Night[];
extern const u8 Matchcall_Erin_Call_Morn[];
extern const u8 Matchcall_Erin_Call_Day[];
extern const u8 Matchcall_Erin_Call_Night[];
extern const u8 Matchcall_Erin_Generic5[];
extern const u8 Matchcall_Erin_Bragging[];
extern const u8 Matchcall_Erin_DefeatedMon[];
extern const u8 Matchcall_Erin_LostMon[];
extern const u8 Matchcall_Erin_Rematch[];
extern const u8 Matchcall_Erin_Hangup[];
extern const u8 Matchcall_Erin_HangupOutgoing[];
extern const u8 Matchcall_Erin_Remind_Rematch[];
extern const u8 Matchcall_Gaven_Answer_Morn[];
extern const u8 Matchcall_Gaven_Answer_Day[];
extern const u8 Matchcall_Gaven_Answer_Night[];
extern const u8 Matchcall_Gaven_Call_Morn[];
extern const u8 Matchcall_Gaven_Call_Day[];
extern const u8 Matchcall_Gaven_Call_Night[];
extern const u8 Matchcall_Gaven_Generic5[];
extern const u8 Matchcall_Gaven_Bragging[];
extern const u8 Matchcall_Gaven_DefeatedMon[];
extern const u8 Matchcall_Gaven_LostMon[];
extern const u8 Matchcall_Gaven_Rematch[];
extern const u8 Matchcall_Gaven_Hangup[];
extern const u8 Matchcall_Gaven_HangupOutgoing[];
extern const u8 Matchcall_Gaven_Remind_Rematch[];
extern const u8 Matchcall_Gina_Answer_Morn[];
extern const u8 Matchcall_Gina_Answer_Day[];
extern const u8 Matchcall_Gina_Answer_Night[];
extern const u8 Matchcall_Gina_Call_Morn[];
extern const u8 Matchcall_Gina_Call_Day[];
extern const u8 Matchcall_Gina_Call_Night[];
extern const u8 Matchcall_Gina_Generic5[];
extern const u8 Matchcall_Gina_Bragging[];
extern const u8 Matchcall_Gina_DefeatedMon[];
extern const u8 Matchcall_Gina_LostMon[];
extern const u8 Matchcall_Gina_Rematch[];
extern const u8 Matchcall_Gina_Hangup[];
extern const u8 Matchcall_Gina_Rocket_Tower[];
extern const u8 Matchcall_Gina_Gift[];
extern const u8 Matchcall_Gina_HangupOutgoing[];
extern const u8 Matchcall_Gina_Remind_Rematch[];
extern const u8 Matchcall_Gina_Remind_Gift[];
extern const u8 Matchcall_Huey_Answer[];
extern const u8 Matchcall_Huey_Call_Morn[];
extern const u8 Matchcall_Huey_Call_Day[];
extern const u8 Matchcall_Huey_Call_Night[];
extern const u8 Matchcall_Huey_Rematch[];
extern const u8 Matchcall_Huey_Hangup[];
extern const u8 Matchcall_Huey_HangupOutgoing[];
extern const u8 Matchcall_Huey_Remind_Rematch[];
extern const u8 Matchcall_Jack_Answer_Morn[];
extern const u8 Matchcall_Jack_Answer_Day[];
extern const u8 Matchcall_Jack_Answer_Night[];
extern const u8 Matchcall_Jack_Call_Morn[];
extern const u8 Matchcall_Jack_Call_Day[];
extern const u8 Matchcall_Jack_Call_Night[];
extern const u8 Matchcall_Jack_Generic16[];
extern const u8 Matchcall_Jack_Bragging[];
extern const u8 Matchcall_Jack_DefeatedMon[];
extern const u8 Matchcall_Jack_LostMon[];
extern const u8 Matchcall_Jack_Rematch[];
extern const u8 Matchcall_Jack_Hangup[];
extern const u8 Matchcall_Jack_Generic12[];
extern const u8 Matchcall_Jack_Generic11[];
extern const u8 Matchcall_Jack_Generic10[];
extern const u8 Matchcall_Jack_Generic9[];
extern const u8 Matchcall_Jack_Generic8[];
extern const u8 Matchcall_Jack_Generic7[];
extern const u8 Matchcall_Jack_Generic6[];
extern const u8 Matchcall_Jack_Generic5[];
extern const u8 Matchcall_Jack_Generic4[];
extern const u8 Matchcall_Jack_Generic3[];
extern const u8 Matchcall_Jack_Generic2[];
extern const u8 Matchcall_Jack_HangupOutgoing[];
extern const u8 Matchcall_Jack_Remind_Rematch[];
extern const u8 Matchcall_Joey_Answer[];
extern const u8 Matchcall_Joey_Call_Morn[];
extern const u8 Matchcall_Joey_Call_Day[];
extern const u8 Matchcall_Joey_Call_Night[];
extern const u8 Matchcall_Joey_Generic[];
extern const u8 Matchcall_Joey_Bragging[];
extern const u8 Matchcall_Joey_DefeatedMon[];
extern const u8 Matchcall_Joey_LostMon[];
extern const u8 Matchcall_Joey_Rematch[];
extern const u8 Matchcall_Joey_Hangup[];
extern const u8 Matchcall_Joey_HangupOutgoing[];
extern const u8 Matchcall_Joey_Remind_Rematch[];
extern const u8 Matchcall_Jose_Answer_Morn[];
extern const u8 Matchcall_Jose_Answer_Day[];
extern const u8 Matchcall_Jose_Answer_Night[];
extern const u8 Matchcall_Jose_Call[];
extern const u8 Matchcall_Jose_Generic5[];
extern const u8 Matchcall_Jose_Bragging[];
extern const u8 Matchcall_Jose_DefeatedMon[];
extern const u8 Matchcall_Jose_LostMon[];
extern const u8 Matchcall_Jose_Rematch[];
extern const u8 Matchcall_Jose_Hangup[];
extern const u8 Matchcall_Jose_Gift[];
extern const u8 Matchcall_Jose_HangupOutgoing[];
extern const u8 Matchcall_Jose_Remind_Rematch[];
extern const u8 Matchcall_Jose_Remind_Gift[];
extern const u8 Matchcall_Liz_Answer_Morn[];
extern const u8 Matchcall_Liz_Answer_Day[];
extern const u8 Matchcall_Liz_Answer_Night[];
extern const u8 Matchcall_Liz_Call_Morn[];
extern const u8 Matchcall_Liz_Call_Day[];
extern const u8 Matchcall_Liz_Call_Night[];
extern const u8 Matchcall_Liz_Generic16[];
extern const u8 Matchcall_Liz_Bragging[];
extern const u8 Matchcall_Liz_DefeatedMon[];
extern const u8 Matchcall_Liz_LostMon[];
extern const u8 Matchcall_Liz_Rematch[];
extern const u8 Matchcall_Liz_Generic12[];
extern const u8 Matchcall_Liz_Hangup[];
extern const u8 Matchcall_Liz_Generic11[];
extern const u8 Matchcall_Liz_Generic10[];
extern const u8 Matchcall_Liz_Generic9[];
extern const u8 Matchcall_Liz_Generic8[];
extern const u8 Matchcall_Liz_Generic7[];
extern const u8 Matchcall_Liz_Generic6[];
extern const u8 Matchcall_Liz_Generic5[];
extern const u8 Matchcall_Liz_Generic4[];
extern const u8 Matchcall_Liz_Generic3[];
extern const u8 Matchcall_Liz_Generic2[];
extern const u8 Matchcall_Liz_HangupOutgoing[];
extern const u8 Matchcall_Liz_Remind_Rematch[];
extern const u8 Matchcall_Parry_Answer[];
extern const u8 Matchcall_Parry_Call_Morn[];
extern const u8 Matchcall_Parry_Call_Day[];
extern const u8 Matchcall_Parry_Call_Night[];
extern const u8 Matchcall_Parry_Generic5[];
extern const u8 Matchcall_Parry_Bragging[];
extern const u8 Matchcall_Parry_DefeatedMon[];
extern const u8 Matchcall_Parry_LostMon[];
extern const u8 Matchcall_Parry_Rematch[];
extern const u8 Matchcall_Parry_Hangup[];
extern const u8 Matchcall_Parry_HangupOutgoing[];
extern const u8 Matchcall_Parry_Remind_Rematch[];
extern const u8 Matchcall_Ralph_Answer[];
extern const u8 Matchcall_Ralph_Call[];
extern const u8 Matchcall_Ralph_Generic5[];
extern const u8 Matchcall_Ralph_Bragging[];
extern const u8 Matchcall_Ralph_DefeatedMon[];
extern const u8 Matchcall_Ralph_LostMon[];
extern const u8 Matchcall_Ralph_Rematch[];
extern const u8 Matchcall_Ralph_Hangup[];
extern const u8 Matchcall_Ralph_Swarm[];
extern const u8 Matchcall_Ralph_HangupOutgoing[];
extern const u8 Matchcall_Ralph_Remind_Rematch[];
extern const u8 Matchcall_Ralph_Remind_Swarm[];
extern const u8 Matchcall_Reena_Answer[];
extern const u8 Matchcall_Reena_Call[];
extern const u8 Matchcall_Reena_Generic5[];
extern const u8 Matchcall_Reena_Bragging[];
extern const u8 Matchcall_Reena_DefeatedMon[];
extern const u8 Matchcall_Reena_LostMon[];
extern const u8 Matchcall_Reena_Rematch[];
extern const u8 Matchcall_Reena_Hangup[];
extern const u8 Matchcall_Reena_HangupOutgoing[];
extern const u8 Matchcall_Reena_Remind_Rematch[];
extern const u8 Matchcall_Tiffany_Answer_Morn[];
extern const u8 Matchcall_Tiffany_Answer_Day[];
extern const u8 Matchcall_Tiffany_Answer_Night[];
extern const u8 Matchcall_Tiffany_Call_Morn[];
extern const u8 Matchcall_Tiffany_Call_Day[];
extern const u8 Matchcall_Tiffany_Call_Night[];
extern const u8 Matchcall_Tiffany_Generic5[];
extern const u8 Matchcall_Tiffany_Bragging[];
extern const u8 Matchcall_Tiffany_DefeatedMon[];
extern const u8 Matchcall_Tiffany_LostMon[];
extern const u8 Matchcall_Tiffany_Rematch[];
extern const u8 Matchcall_Tiffany_Generic1[];
extern const u8 Matchcall_Tiffany_Hangup[];
extern const u8 Matchcall_Tiffany_Gift[];
extern const u8 Matchcall_Tiffany_HangupOutgoing[];
extern const u8 Matchcall_Tiffany_Remind_Rematch[];
extern const u8 Matchcall_Tiffany_Remind_Gift[];
extern const u8 Matchcall_Tully_Answer_Morn[];
extern const u8 Matchcall_Tully_Answer_Day[];
extern const u8 Matchcall_Tully_Answer_Night[];
extern const u8 Matchcall_Tully_Call_Morn[];
extern const u8 Matchcall_Tully_Call_Day[];
extern const u8 Matchcall_Tully_Call_Night[];
extern const u8 Matchcall_Tully_Generic5[];
extern const u8 Matchcall_Tully_Bragging[];
extern const u8 Matchcall_Tully_DefeatedMon[];
extern const u8 Matchcall_Tully_LostMon[];
extern const u8 Matchcall_Tully_Rematch[];
extern const u8 Matchcall_Tully_Hangup[];
extern const u8 Matchcall_Tully_Gift[];
extern const u8 Matchcall_Tully_HangupOutgoing[];
extern const u8 Matchcall_Tully_Remind_Rematch[];
extern const u8 Matchcall_Tully_Remind_Gift[];
extern const u8 Matchcall_Vance_Answer_Morn[];
extern const u8 Matchcall_Vance_Answer_Day[];
extern const u8 Matchcall_Vance_Answer_Night[];
extern const u8 Matchcall_Vance_Call_Morn[];
extern const u8 Matchcall_Vance_Call_Day[];
extern const u8 Matchcall_Vance_Call_Night[];
extern const u8 Matchcall_Vance_Generic5[];
extern const u8 Matchcall_Vance_Bragging[];
extern const u8 Matchcall_Vance_DefeatedMon[];
extern const u8 Matchcall_Vance_LostMon[];
extern const u8 Matchcall_Vance_Rematch[];
extern const u8 Matchcall_Vance_Hangup[];
extern const u8 Matchcall_Vance_HangupOutgoing[];
extern const u8 Matchcall_Vance_Remind_Rematch[];
extern const u8 Matchcall_Wade_Answer_Morn[];
extern const u8 Matchcall_Wade_Answer_Day[];
extern const u8 Matchcall_Wade_Answer_Night[];
extern const u8 Matchcall_Wade_Call_Morn[];
extern const u8 Matchcall_Wade_Call_Day[];
extern const u8 Matchcall_Wade_Call_Night[];
extern const u8 Matchcall_Wade_Generic5[];
extern const u8 Matchcall_Wade_Bragging[];
extern const u8 Matchcall_Wade_DefeatedMon[];
extern const u8 Matchcall_Wade_LostMon[];
extern const u8 Matchcall_Wade_Rematch[];
extern const u8 Matchcall_Wade_Hangup[];
extern const u8 Matchcall_Wade_Gift[];
extern const u8 Matchcall_Wade_HangupOutgoing[];
extern const u8 Matchcall_Wade_Remind_Rematch[];
extern const u8 Matchcall_Wade_Remind_Gift[];
extern const u8 Matchcall_Wilton_Answer_Morn[];
extern const u8 Matchcall_Wilton_Answer_Day[];
extern const u8 Matchcall_Wilton_Answer_Night[];
extern const u8 Matchcall_Wilton_Call_Morn[];
extern const u8 Matchcall_Wilton_Call_Day[];
extern const u8 Matchcall_Wilton_Call_Night[];
extern const u8 Matchcall_Wilton_Generic2[];
extern const u8 Matchcall_Wilton_Bragging[];
extern const u8 Matchcall_Wilton_DefeatedMon[];
extern const u8 Matchcall_Wilton_LostMon[];
extern const u8 Matchcall_Wilton_Rematch[];
extern const u8 Matchcall_Wilton_Hangup[];
extern const u8 Matchcall_Wilton_Gift[];
extern const u8 Matchcall_Wilton_HangupOutgoing[];
extern const u8 Matchcall_Wilton_Remind_Rematch[];
extern const u8 Matchcall_Wilton_Remind_Gift[];
extern const u8 Matchcall_Todd_Answer_Morn[];
extern const u8 Matchcall_Todd_Answer_Day[];
extern const u8 Matchcall_Todd_Answer_Night[];
extern const u8 Matchcall_Todd_Call_Morn[];
extern const u8 Matchcall_Todd_Call_Day[];
extern const u8 Matchcall_Todd_Call_Night[];
extern const u8 Matchcall_Todd_Generic1[];
extern const u8 Matchcall_Todd_Bragging[];
extern const u8 Matchcall_Todd_DefeatedMon[];
extern const u8 Matchcall_Todd_LostMon[];
extern const u8 Matchcall_Todd_Rematch[];
extern const u8 Matchcall_Todd_Hangup[];
extern const u8 Matchcall_Todd_HangupOutgoing[];
extern const u8 Matchcall_Todd_Remind_Rematch[];
extern const u8 Matchcall_Todd_Remind_Goldenrod_Dept_Sale[];
