...
struct SaveBlock1
{
    ...
    /*0xAF0*/ u8 seen1[DEX_FLAGS_NO];
    /*0xB24*/ u16 berryBlenderRecords[3];
    /*0xB2A*/ u8 field_9C2[6];
    ...
    /*0x2CFD*/ u8 outbreakUnk1;
    /*0x2CFE*/ u16 outbreakUnk2;
    /*0x2D00*/ u16 outbreakPokemonMoves[MAX_MON_MOVES];
    /*0x2D08*/ u8 outbreakUnk4;
    ...
    /*0x2D48*/ struct MailStruct mail[MAIL_COUNT];
    /*0x2F88*/ u8 additionalPhrases[8]; // bitfield for 33 additional phrases in easy chat system
    ...
    /*0x3344*/ struct Roamer roamer[2];
    /*0x335C*/ u8 padding_31F4[4];
    /*0x3360*/ struct EnigmaBerry enigmaBerry;
    /*0x3394*/ struct MEventBuffers unk_322C;
    /*0x3700*/ u8 field_3598[0];
