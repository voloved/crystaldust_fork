...
#define B_TXT_CAUGHT_BUG_CATCHING_CONTEST_MON 0x35
...
extern const u8 gText_PkmnIsDevolving[];
extern const u8 gText_CongratsPkmnDevolved[];
extern const u8 gText_PkmnStoppedDevolving[];
extern const u8 gText_EllipsisQuestionMark[];
extern const u8 gText_WhatWillPkmnDo[];
extern const u8 gText_WhatWillPkmnDo2[];
extern const u8 gText_WhatWillTheDudeDo[];
extern const u8 gText_LinkStandby[];
extern const u8 gText_BattleMenu[];
extern const u8 gText_SafariZoneMenu[];
extern const u8 gText_BugCatchingContestMenu[];
