...
#define BATTLE_TYPE_DUDE_TUTORIAL      (1 << 9)
#define BATTLE_TYPE_ROAMER             (1 << 10)
#define BATTLE_TYPE_EREADER_TRAINER    (1 << 11)
#define BATTLE_TYPE_BUG_CATCHING_CONTEST (1 << 12)
...
#define BATTLE_TYPE_FISHING            (1 << 28)
#define BATTLE_TYPE_TREE               (1 << 29)
...
#define TUTORIAL_BATTLE_HEAL_AFTER  1
...
#define B_OUTCOME_NO_PARK_BALLS        11
...
#define BATTLE_TERRAIN_RAYQUAZA     20
#define BATTLE_TERRAIN_FRONTIER     21
