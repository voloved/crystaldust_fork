...
const s8 gUnknown_0831ACE0[] ={-32, -16, -16, -32, -32, 0, 0, 0};
...
{
    {TRAINER_CLASS_TEAM_ROCKET, 10}, //Grunts only
    {TRAINER_CLASS_AQUA_ADMIN, 10},
    {TRAINER_CLASS_AQUA_LEADER, 20},
    {TRAINER_CLASS_AROMA_LADY, 10},
    {TRAINER_CLASS_RUIN_MANIAC, 15},
    {TRAINER_CLASS_OFFICER, 10},
    ...
    {TRAINER_CLASS_PSYCHIC, 8},
    {TRAINER_CLASS_GENTLEMAN, 18},
    {TRAINER_CLASS_ELITE_FOUR, 25},
    {TRAINER_CLASS_LEADER, 25},
    {TRAINER_CLASS_SCHOOL_KID, 8},
    ...
    {TRAINER_CLASS_LASS, 6},
    {TRAINER_CLASS_BUG_CATCHER, 4},
    {TRAINER_CLASS_HIKER, 8},
    {TRAINER_CLASS_YOUNG_COUPLE, 8},
    {TRAINER_CLASS_RIVAL1, 15},
    {TRAINER_CLASS_KIMONO_GIRL, 18},
    {TRAINER_CLASS_MEDIUM, 10},
    {TRAINER_CLASS_MYSTICALMAN, 25},
    {TRAINER_CLASS_SCIENTIST, 25},
    {TRAINER_CLASS_SKIER, 18},
    {TRAINER_CLASS_BOARDER, 18},
    {TRAINER_CLASS_BURGLAR, 22},
    {TRAINER_CLASS_TEACHER, 18},
    {TRAINER_CLASS_BIKER, 8},
    {TRAINER_CLASS_RIVAL2, 25},
    {TRAINER_CLASS_TEAM_ROCKET_EXECUTIVE, 18},
    {0xFF, 5},
};
