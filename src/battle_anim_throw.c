...
{
    [BALLGFX_POKE]      = {gBattleAnimSpriteGfx_Particles,           0x160, TAG_BALL_PARTICLES(POKE)},
    [BALLGFX_GREAT]     = {gBattleAnimSpriteGfx_Particles,           0x160, TAG_BALL_PARTICLES(GREAT)},
    [BALLGFX_SAFARI]    = {gBattleAnimSpriteGfx_Particles,           0x160, TAG_BALL_PARTICLES(SAFARI)},
    [BALLGFX_ULTRA]     = {gBattleAnimSpriteGfx_Particles,           0x160, TAG_BALL_PARTICLES(ULTRA)},
    [BALLGFX_MASTER]    = {gBattleAnimSpriteGfx_Particles,           0x160, TAG_BALL_PARTICLES(MASTER)},
    [BALLGFX_NET]       = {gBattleAnimSpriteGfx_Particles,           0x160, TAG_BALL_PARTICLES(NET)},
    [BALLGFX_DIVE]      = {gBattleAnimSpriteGfx_Particles,           0x160, TAG_BALL_PARTICLES(DIVE)},
    [BALLGFX_NEST]      = {gBattleAnimSpriteGfx_Particles,           0x160, TAG_BALL_PARTICLES(NEST)},
...
static const struct CompressedSpritePalette sBallParticlePalettes[BALLGFX_COUNT] =
{
    ...
    [BALLGFX_SAFARI]    = {gBattleAnimSpritePal_CircleImpact, TAG_BALL_PARTICLES(SAFARI)},
    [BALLGFX_ULTRA]     = {gBattleAnimSpritePal_CircleImpact, TAG_BALL_PARTICLES(ULTRA)},
    [BALLGFX_MASTER]    = {gBattleAnimSpritePal_CircleImpact, TAG_BALL_PARTICLES(MASTER)},
    [BALLGFX_NET]       = {gBattleAnimSpritePal_CircleImpact, TAG_BALL_PARTICLES(NET)},
    [BALLGFX_DIVE]      = {gBattleAnimSpritePal_CircleImpact, TAG_BALL_PARTICLES(DIVE)},
    [BALLGFX_NEST]      = {gBattleAnimSpritePal_CircleImpact, TAG_BALL_PARTICLES(NEST)},
    ...
    [BALLGFX_FRIEND]    = {gBattleAnimSpritePal_CircleImpact, TAG_BALL_PARTICLES(FRIEND)},
    [BALLGFX_FAST]      = {gBattleAnimSpritePal_CircleImpact, TAG_BALL_PARTICLES(FAST)},
    [BALLGFX_HEAVY]     = {gBattleAnimSpritePal_CircleImpact, TAG_BALL_PARTICLES(HEAVY)},
    [BALLGFX_LOVE]      = {gBattleAnimSpritePal_CircleImpact, TAG_BALL_PARTICLES(LOVE)},
    [BALLGFX_PARK]      = {gBattleAnimSpritePal_CircleImpact, TAG_BALL_PARTICLES(PARK)},
};
...
static const TaskFunc sBallParticleAnimationFuncs[BALLGFX_COUNT] =
{
    ...
    [BALLGFX_SAFARI]    = SafariBallOpenParticleAnimation,
    [BALLGFX_ULTRA]     = UltraBallOpenParticleAnimation,
    [BALLGFX_MASTER]    = MasterBallOpenParticleAnimation,
    [BALLGFX_NET]       = SafariBallOpenParticleAnimation,
    [BALLGFX_DIVE]      = DiveBallOpenParticleAnimation,
    [BALLGFX_NEST]      = UltraBallOpenParticleAnimation,
...
static const struct SpriteTemplate sBallParticleSpriteTemplates[BALLGFX_COUNT] =
{
    [BALLGFX_POKE] = {
        ...
        .paletteTag = TAG_BALL_PARTICLES(POKE),
    ...
    [BALLGFX_GREAT] = {
        .tileTag = TAG_BALL_PARTICLES(GREAT),
        .paletteTag = TAG_BALL_PARTICLES(GREAT),
        .oam = &gOamData_AffineOff_ObjNormal_8x8,
        .anims = sAnims_BallParticles,
        .images = NULL,
        .affineAnims = gDummySpriteAffineAnimTable,
    ...
    [BALLGFX_SAFARI] = {
        .tileTag = TAG_BALL_PARTICLES(SAFARI),
        .paletteTag = TAG_BALL_PARTICLES(SAFARI),
        .oam = &gOamData_AffineOff_ObjNormal_8x8,
        .anims = sAnims_BallParticles,
        .images = NULL,
        .affineAnims = gDummySpriteAffineAnimTable,
    ...
    [BALLGFX_ULTRA] = {
        .tileTag = TAG_BALL_PARTICLES(ULTRA),
        .paletteTag = TAG_BALL_PARTICLES(ULTRA),
        .oam = &gOamData_AffineOff_ObjNormal_8x8,
        .anims = sAnims_BallParticles,
        .images = NULL,
        .affineAnims = gDummySpriteAffineAnimTable,
    ...
    [BALLGFX_MASTER] = {
        .tileTag = TAG_BALL_PARTICLES(MASTER),
        .paletteTag = TAG_BALL_PARTICLES(MASTER),
        .oam = &gOamData_AffineOff_ObjNormal_8x8,
        .anims = sAnims_BallParticles,
        .images = NULL,
        .affineAnims = gDummySpriteAffineAnimTable,
    ...
    [BALLGFX_NET] = {
        .tileTag = TAG_BALL_PARTICLES(NET),
        .paletteTag = TAG_BALL_PARTICLES(NET),
        .oam = &gOamData_AffineOff_ObjNormal_8x8,
        .anims = sAnims_BallParticles,
        .images = NULL,
        .affineAnims = gDummySpriteAffineAnimTable,
    ...
    [BALLGFX_DIVE] = {
        .tileTag = TAG_BALL_PARTICLES(DIVE),
        .paletteTag = TAG_BALL_PARTICLES(DIVE),
        .oam = &gOamData_AffineOff_ObjNormal_8x8,
        .anims = sAnims_BallParticles,
        .images = NULL,
        .affineAnims = gDummySpriteAffineAnimTable,
    ...
    [BALLGFX_NEST] = {
        .tileTag = TAG_BALL_PARTICLES(NEST),
        .paletteTag = TAG_BALL_PARTICLES(NEST),
        .oam = &gOamData_AffineOff_ObjNormal_8x8,
        .anims = sAnims_BallParticles,
        .images = NULL,
        .affineAnims = gDummySpriteAffineAnimTable,
    ...
    [BALLGFX_REPEAT] = {
        .tileTag = TAG_BALL_PARTICLES(REPEAT),
        .paletteTag = TAG_BALL_PARTICLES(REPEAT),
        .oam = &gOamData_AffineOff_ObjNormal_8x8,
        .anims = sAnims_BallParticles,
        .images = NULL,
        .affineAnims = gDummySpriteAffineAnimTable,
    ...
    [BALLGFX_TIMER] = {
        .tileTag = TAG_BALL_PARTICLES(TIMER),
        .paletteTag = TAG_BALL_PARTICLES(TIMER),
        .oam = &gOamData_AffineOff_ObjNormal_8x8,
        .anims = sAnims_BallParticles,
        .images = NULL,
        .affineAnims = gDummySpriteAffineAnimTable,
    ...
    [BALLGFX_LUXURY] = {
        .tileTag = TAG_BALL_PARTICLES(LUXURY),
        .paletteTag = TAG_BALL_PARTICLES(LUXURY),
        .oam = &gOamData_AffineOff_ObjNormal_8x8,
        .anims = sAnims_BallParticles,
        .images = NULL,
        .affineAnims = gDummySpriteAffineAnimTable,
    ...
    [BALLGFX_LEVEL] = {
        .tileTag = TAG_BALL_PARTICLES(LEVEL),
        .paletteTag = TAG_BALL_PARTICLES(LEVEL),
        .oam = &gOamData_AffineOff_ObjNormal_8x8,
        .anims = sAnims_BallParticles,
        .images = NULL,
        .affineAnims = gDummySpriteAffineAnimTable,
    ...
    [BALLGFX_LURE] = {
        .tileTag = TAG_BALL_PARTICLES(LURE),
        .paletteTag = TAG_BALL_PARTICLES(LURE),
        .oam = &gOamData_AffineOff_ObjNormal_8x8,
        .anims = sAnims_BallParticles,
        .images = NULL,
        .affineAnims = gDummySpriteAffineAnimTable,
    ...
    [BALLGFX_FRIEND] = {
        .tileTag = TAG_BALL_PARTICLES(FRIEND),
        .paletteTag = TAG_BALL_PARTICLES(FRIEND),
        .oam = &gOamData_AffineOff_ObjNormal_8x8,
        .anims = sAnims_BallParticles,
        .images = NULL,
        .affineAnims = gDummySpriteAffineAnimTable,
    ...
    [BALLGFX_HEAVY] = {
        .tileTag = TAG_BALL_PARTICLES(HEAVY),
        .paletteTag = TAG_BALL_PARTICLES(HEAVY),
        .oam = &gOamData_AffineOff_ObjNormal_8x8,
        .anims = sAnims_BallParticles,
        .images = NULL,
        .affineAnims = gDummySpriteAffineAnimTable,
    ...
    [BALLGFX_LOVE] = {
        .tileTag = TAG_BALL_PARTICLES(LOVE),
        .paletteTag = TAG_BALL_PARTICLES(LOVE),
        .oam = &gOamData_AffineOff_ObjNormal_8x8,
        .anims = sAnims_BallParticles,
        .images = NULL,
        .affineAnims = gDummySpriteAffineAnimTable,
...
{
    [BALLGFX_POKE]      = RGB(31, 22, 30),
    [BALLGFX_GREAT]     = RGB(16, 23, 30),
    [BALLGFX_SAFARI]    = RGB(23, 30, 20),
    [BALLGFX_ULTRA]     = RGB(31, 31, 15),
    [BALLGFX_MASTER]    = RGB(23, 20, 28),
    [BALLGFX_NET]       = RGB(21, 31, 25),
    [BALLGFX_DIVE]      = RGB(12, 25, 30),
    [BALLGFX_NEST]      = RGB(30, 27, 10),
...
{
    u8 ballId = BallIdToGfxId(ITEM_ID_TO_BALL_ID(gLastUsedItem));
    LoadBallGfx(ballId);
    DestroyAnimVisualTask(taskId);
}
...
u8 BallIdToGfxId(u16 ballItem)
{
    switch (ballItem)
    {
    case BALL_MASTER:
        return BALLGFX_MASTER;
    case BALL_ULTRA:
        return BALLGFX_ULTRA;
    case BALL_GREAT:
        return BALLGFX_GREAT;
    case BALL_SAFARI:
        return BALLGFX_SAFARI;
    case BALL_NET:
        return BALLGFX_NET;
    case BALL_DIVE:
        return BALLGFX_DIVE;
...
static void MakeCaptureStars(struct Sprite *sprite)
{
    ...
    {
        u8 spriteId = CreateSprite(&sBallParticleSpriteTemplates[4], sprite->x, sprite->y, subpriority);
        if (spriteId != MAX_SPRITES)
        {
            ...
            StartSpriteAnim(&gSprites[spriteId], sBallParticleAnimNums[BALLGFX_MASTER]);
        }
    }
}
...
static void LevelBallOpenParticleAnimation(u8 taskId)
{
    ...
    if (task->data[0] < 16)
    {
        ...
        default:
            ...
            anim = sBallParticleAnimNums[BALLGFX_POKE];
            break;
        }
