...
static const u8 sText_Someones[] = _("BILL's");
...
const u8 * const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_DUDEUSEDITEM - 12] = sText_TheDudeUsedItem,
...
const u8 gText_PkmnIsDevolving[] = _("What?\n{STR_VAR_1} is devolving!");
const u8 gText_CongratsPkmnDevolved[] = _("Congratulations! Your {STR_VAR_1}\ndevolved into {STR_VAR_2}!{WAIT_SE}\p");
const u8 gText_PkmnStoppedDevolving[] = _("Huh? {STR_VAR_1}\nstopped devolving!\p");
const u8 gText_EllipsisQuestionMark[] = _("……?\p");
const u8 gText_WhatWillPkmnDo[] = _("What will\n{B_ACTIVE_NAME_WITH_PREFIX} do?");
const u8 gText_WhatWillPkmnDo2[] = _("What will\n{B_PLAYER_NAME} do?");
const u8 gText_WhatWillTheDudeDo[] = _("What will\nthe dude do?");
    ...
    while (*src != EOS)
    {
        if (*src == PLACEHOLDER_BEGIN)
        {
            ...
            case B_TXT_TRAINER1_NAME: // trainer1 name
                ...
                {
                    if (gTrainers[gTrainerBattleOpponent_A].trainerClass == TRAINER_CLASS_RIVAL1
                     || gTrainers[gTrainerBattleOpponent_A].trainerClass == TRAINER_CLASS_RIVAL2)
                    {
...
void BattlePutTextOnWindow(const u8 *text, u32 windowId)
{
