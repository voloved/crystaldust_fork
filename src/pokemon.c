...
const u16 gSpeciesToJohtoPokedexNum[] = // Assigns all species to the Johto Dex Index (Summary No. for Johto Dex)
{
    ...
    SPECIES_TO_JOHTO(WEAVILE),
    SPECIES_TO_JOHTO(MAGNEZONE),
    SPECIES_TO_JOHTO(LICKILICKY),
    SPECIES_TO_JOHTO(RHYPERIOR),
    SPECIES_TO_JOHTO(TANGROWTH),
    SPECIES_TO_JOHTO(ELECTIVIRE),
    SPECIES_TO_JOHTO(MAGMORTAR),
    SPECIES_TO_JOHTO(TOGEKISS),
    SPECIES_TO_JOHTO(YANMEGA),
    SPECIES_TO_JOHTO(GLISCOR),
    SPECIES_TO_JOHTO(MAMOSWINE),
    SPECIES_TO_JOHTO(PORYGON_Z),
    SPECIES_TO_JOHTO(GALLADE),
    SPECIES_TO_JOHTO(PROBOPASS),
    SPECIES_TO_JOHTO(DUSKNOIR),
    SPECIES_TO_JOHTO(ROSERADE),
    SPECIES_TO_JOHTO(AMBIPOM),
    SPECIES_TO_JOHTO(MISMAGIUS),
    SPECIES_TO_JOHTO(HONCHKROW),
    SPECIES_TO_JOHTO(FROSLASS),
    SPECIES_TO_JOHTO(URSALUNA),
    SPECIES_TO_JOHTO(ANNIHILAPE),
...
static const u16 sHMMoves[] =
{
    ...
    MOVE_ROCK_SMASH, MOVE_WATERFALL, MOVE_WHIRLPOOL, MOVE_DIVE, 0xFFFF
};
...
static bool32 CanEvolve(u16 species)
{
    u32 i;
...
s32 CalculateBaseDamage(struct BattlePokemon *attacker, struct BattlePokemon *defender, u32 move, u16 sideStatus, u16 powerOverride, u8 typeOverride, u8 battlerIdAtk, u8 battlerIdDef)
{
    ...
    for (i = 0; i < ARRAY_COUNT(sHoldEffectToType); i++)
    {
        ...
        {
            if (isMovePhysical(gCurrentMove))
