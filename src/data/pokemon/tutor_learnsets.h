...
static const u64 sTutorLearnsets[] =
{
    ...
    [SPECIES_WEAVILE]          = (TUTOR(MOVE_DREAM_EATER)
                                | TUTOR(MOVE_ENDURE)
                                | TUTOR(MOVE_FURY_CUTTER)
                                | TUTOR(MOVE_ICE_PUNCH)
                                | TUTOR(MOVE_ICY_WIND)
    ...
    [SPECIES_RHYPERIOR]        = (TUTOR(MOVE_ENDURE)
                                | TUTOR(MOVE_FIRE_PUNCH)
                                | TUTOR(MOVE_FURY_CUTTER)
                                | TUTOR(MOVE_ICE_PUNCH)
                                | TUTOR(MOVE_ICY_WIND)
    ...
    [SPECIES_TANGROWTH]        = (TUTOR(MOVE_ENDURE)
                                | TUTOR(MOVE_MUD_SLAP)
                                | TUTOR(MOVE_PSYCH_UP)
                                | TUTOR(MOVE_ROCK_SLIDE)
                                | TUTOR(MOVE_SLEEP_TALK)
    ...
    [SPECIES_ELECTIVIRE]       = (TUTOR(MOVE_ENDURE)
                                | TUTOR(MOVE_FIRE_PUNCH)
                                | TUTOR(MOVE_ICE_PUNCH)
                                | TUTOR(MOVE_MUD_SLAP)
                                | TUTOR(MOVE_ROCK_SLIDE)
    ...
    [SPECIES_MAGMORTAR]        = (TUTOR(MOVE_ENDURE)
                                | TUTOR(MOVE_FIRE_PUNCH)
                                | TUTOR(MOVE_MUD_SLAP)
                                | TUTOR(MOVE_ROCK_SLIDE)
                                | TUTOR(MOVE_SLEEP_TALK)
    ...
    [SPECIES_TOGEKISS]         = (TUTOR(MOVE_DREAM_EATER)
                                | TUTOR(MOVE_ENDURE)
                                | TUTOR(MOVE_MUD_SLAP)
                                | TUTOR(MOVE_PSYCH_UP)
                                | TUTOR(MOVE_ROLLOUT)
    ...
    [SPECIES_GLISCOR]          = (TUTOR(MOVE_ENDURE)
                                | TUTOR(MOVE_FURY_CUTTER)
                                | TUTOR(MOVE_MUD_SLAP)
                                | TUTOR(MOVE_ROCK_SLIDE)
                                | TUTOR(MOVE_SLEEP_TALK)
    ...
    [SPECIES_MAMOSWINE]        = (TUTOR(MOVE_ENDURE)
                                | TUTOR(MOVE_ICY_WIND)
                                | TUTOR(MOVE_MUD_SLAP)
                                | TUTOR(MOVE_ROCK_SLIDE)
                                | TUTOR(MOVE_SLEEP_TALK)
    ...
    [SPECIES_PORYGON_Z]        = (TUTOR(MOVE_DREAM_EATER)
                                | TUTOR(MOVE_ENDURE)
                                | TUTOR(MOVE_ICY_WIND)
                                | TUTOR(MOVE_PSYCH_UP)
                                | TUTOR(MOVE_SLEEP_TALK)
    ...
    [SPECIES_GALLADE]          = (TUTOR(MOVE_DREAM_EATER)
                                | TUTOR(MOVE_ENDURE)
                                | TUTOR(MOVE_FIRE_PUNCH)
                                | TUTOR(MOVE_FURY_CUTTER)
                                | TUTOR(MOVE_ICE_PUNCH)
    ...
    [SPECIES_PROBOPASS]        = (TUTOR(MOVE_ENDURE)
                                | TUTOR(MOVE_EXPLOSION)
                                | TUTOR(MOVE_FIRE_PUNCH)
                                | TUTOR(MOVE_ICE_PUNCH)
                                | TUTOR(MOVE_MUD_SLAP)
    ...
    [SPECIES_DUSKNOIR]         = (TUTOR(MOVE_DREAM_EATER)
                                | TUTOR(MOVE_ENDURE)
                                | TUTOR(MOVE_FIRE_PUNCH)
                                | TUTOR(MOVE_ICE_PUNCH)
                                | TUTOR(MOVE_ICY_WIND)
    ...
    [SPECIES_FROSLASS]         = (TUTOR(MOVE_ROLLOUT)
                                | TUTOR(MOVE_MUD_SLAP)
                                | TUTOR(MOVE_ICY_WIND)
                                | TUTOR(MOVE_SLEEP_TALK)
                                | TUTOR(MOVE_SNORE)
    ...
    [SPECIES_LEAFEON]          = (TUTOR(MOVE_ENDURE)
                                | TUTOR(MOVE_FURY_CUTTER)
                                | TUTOR(MOVE_MUD_SLAP)
                                | TUTOR(MOVE_SLEEP_TALK)
                                | TUTOR(MOVE_SNORE)
