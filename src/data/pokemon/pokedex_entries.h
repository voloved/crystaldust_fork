const struct PokedexEntry gPokedexEntries[] =
{
    ...
    [NATIONAL_DEX_WEAVILE] =
    {
        ...
        .pokedexShowEntry = gWeavilePokedexText,
        .pokemonScale = 413,
        .pokemonOffset = -3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_MAGNEZONE] =
    {
        ...
        .pokedexShowEntry = gMagnezonePokedexText,
        .pokemonScale = 292,
        .pokemonOffset = 1,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_LICKILICKY] =
    {
        ...
        .pokedexShowEntry = gLickilickyPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_RHYPERIOR] =
    {
        ...
        .pokedexShowEntry = gRhyperiorPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 1,
        .trainerScale = 299,
        .trainerOffset = 2,
    ...
    [NATIONAL_DEX_TANGROWTH] =
    {
        ...
        .pokedexShowEntry = gTangrowthPokedexText,
        .pokemonScale = 304,
        .pokemonOffset = 1,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ELECTIVIRE] =
    {
        ...
        .pokedexShowEntry = gElectivirePokedexText,
        .pokemonScale = 351,
        .pokemonOffset = 8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_MAGMORTAR] =
    {
        ...
        .pokedexShowEntry = gMagmortarPokedexText,
        .pokemonScale = 277,
        .pokemonOffset = 5,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_TOGEKISS] =
    {
        ...
        .pokedexShowEntry = gTogekissPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 318,
        .trainerOffset = 3,
    ...
    [NATIONAL_DEX_YANMEGA] =
    {
        ...
        .pokedexShowEntry = gYanmegaPokedexText,
        .pokemonScale = 274,
        .pokemonOffset = -1,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_GLISCOR] =
    {
        ...
        .pokedexShowEntry = gGliscorPokedexText,
        .pokemonScale = 350,
        .pokemonOffset = -1,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_MAMOSWINE] =
    {
        ...
        .pokedexShowEntry = gMamoswinePokedexText,
        .pokemonScale = 306,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_PORYGON_Z] =
    {
        ...
        .pokedexShowEntry = gPorygonZPokedexText,
        .pokemonScale = 320,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_GALLADE] =
    {
        ...
        .pokedexShowEntry = gGalladePokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_PROBOPASS] =
    {
        ...
        .pokedexShowEntry = gProbopassPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 9,
        .trainerScale = 289,
        .trainerOffset = 3,
    ...
    [NATIONAL_DEX_DUSKNOIR] =
    {
        ...
        .pokedexShowEntry = gDusknoirPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 3,
        .trainerScale = 299,
        .trainerOffset = 1,
    ...
    [NATIONAL_DEX_URSALUNA] =
    {
        ...
        .pokedexShowEntry = gUrsalunaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 3,
        .trainerScale = 369,
        .trainerOffset = 7,
    ...
    [NATIONAL_DEX_ANNIHILAPE] =
    {
        ...
        .pokedexShowEntry = gAnnihilapePokedexText,
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_LEAFEON] =
    {
        ...
        .pokedexShowEntry = gLeafeonPokedexText,
        .pokemonScale = 317,
        .pokemonOffset = 11,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_GLACEON] =
    {
        ...
        .pokedexShowEntry = gGlaceonPokedexText,
        .pokemonScale = 317,
        .pokemonOffset = 11,
        .trainerScale = 256,
        .trainerOffset = 0,
