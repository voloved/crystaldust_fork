...
const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_EEVEE]      = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
                            ...
                            {EVO_ITEM, ITEM_NEVER_MELT_ICE, SPECIES_GLACEON}},
    [SPECIES_JOLTEON]    = {{EVO_ITEM, ITEM_EVERSTONE, SPECIES_EEVEE},
                            {EVO_ITEM, ITEM_WATER_STONE, SPECIES_VAPOREON},
                            {EVO_ITEM, ITEM_FIRE_STONE, SPECIES_FLAREON},
                            {EVO_ITEM, ITEM_SUN_STONE, SPECIES_ESPEON},
                            {EVO_ITEM, ITEM_MOON_STONE, SPECIES_UMBREON},
                            {EVO_ITEM, ITEM_LEAF_STONE, SPECIES_LEAFEON},
                            {EVO_ITEM, ITEM_NEVER_MELT_ICE, SPECIES_GLACEON}},                    
    [SPECIES_VAPOREON]   = {{EVO_ITEM, ITEM_EVERSTONE, SPECIES_EEVEE},
                            ...
                            {EVO_ITEM, ITEM_LEAF_STONE, SPECIES_LEAFEON},
                            {EVO_ITEM, ITEM_NEVER_MELT_ICE, SPECIES_GLACEON}},
    [SPECIES_FLAREON]    = {{EVO_ITEM, ITEM_EVERSTONE, SPECIES_EEVEE},
                            {EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
                            {EVO_ITEM, ITEM_WATER_STONE, SPECIES_VAPOREON},
                            {EVO_ITEM, ITEM_SUN_STONE, SPECIES_ESPEON},
                            {EVO_ITEM, ITEM_MOON_STONE, SPECIES_UMBREON},
                            {EVO_ITEM, ITEM_LEAF_STONE, SPECIES_LEAFEON},
                            {EVO_ITEM, ITEM_NEVER_MELT_ICE, SPECIES_GLACEON}},                     
    [SPECIES_ESPEON]     = {{EVO_ITEM, ITEM_EVERSTONE, SPECIES_EEVEE},
                            {EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
                            {EVO_ITEM, ITEM_WATER_STONE, SPECIES_VAPOREON},
                            {EVO_ITEM, ITEM_FIRE_STONE, SPECIES_FLAREON},
                            {EVO_ITEM, ITEM_MOON_STONE, SPECIES_UMBREON},
                            {EVO_ITEM, ITEM_LEAF_STONE, SPECIES_LEAFEON},
                            {EVO_ITEM, ITEM_NEVER_MELT_ICE, SPECIES_GLACEON}},
    [SPECIES_UMBREON]    = {{EVO_ITEM, ITEM_EVERSTONE, SPECIES_EEVEE},
                            {EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
                            {EVO_ITEM, ITEM_WATER_STONE, SPECIES_VAPOREON},
                            {EVO_ITEM, ITEM_FIRE_STONE, SPECIES_FLAREON},
                            {EVO_ITEM, ITEM_SUN_STONE, SPECIES_ESPEON},
                            {EVO_ITEM, ITEM_LEAF_STONE, SPECIES_LEAFEON},
                            {EVO_ITEM, ITEM_NEVER_MELT_ICE, SPECIES_GLACEON}},                        
    [SPECIES_LEAFEON]    = {{EVO_ITEM, ITEM_EVERSTONE, SPECIES_EEVEE},
                            {EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
                            {EVO_ITEM, ITEM_WATER_STONE, SPECIES_VAPOREON},
                            {EVO_ITEM, ITEM_FIRE_STONE, SPECIES_FLAREON},
                            {EVO_ITEM, ITEM_SUN_STONE, SPECIES_ESPEON},
                            {EVO_ITEM, ITEM_MOON_STONE, SPECIES_UMBREON},
                            {EVO_ITEM, ITEM_NEVER_MELT_ICE, SPECIES_GLACEON}},
    [SPECIES_GLACEON]    = {{EVO_ITEM, ITEM_EVERSTONE, SPECIES_EEVEE},
                            {EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
                            {EVO_ITEM, ITEM_WATER_STONE, SPECIES_VAPOREON},
                            {EVO_ITEM, ITEM_FIRE_STONE, SPECIES_FLAREON},
                            {EVO_ITEM, ITEM_SUN_STONE, SPECIES_ESPEON},
    ...
    [SPECIES_PORYGON2]   = {{EVO_TRADE_ITEM, ITEM_UP_GRADE, SPECIES_PORYGON_Z},
                            {EVO_ITEM, ITEM_UP_GRADE, SPECIES_PORYGON_Z}},
    ...
    [SPECIES_TOGEPI]     = {{EVO_FRIENDSHIP, 0, SPECIES_TOGETIC},
                            {EVO_LEVEL, 27, SPECIES_TOGETIC}},
    [SPECIES_TOGETIC]    = {{EVO_ITEM, ITEM_MOON_STONE,SPECIES_TOGEKISS}},
    ...
    [SPECIES_YANMA]      = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_YANMEGA}},
    ...
    [SPECIES_GLIGAR]     = {{EVO_LEVEL, 32, SPECIES_GLISCOR}},
    [SPECIES_SNUBBULL]   = {{EVO_LEVEL, 23, SPECIES_GRANBULL}},
    [SPECIES_TEDDIURSA]  = {{EVO_LEVEL, 30, SPECIES_URSARING}},
    [SPECIES_SNEASEL]    = {{EVO_ITEM, ITEM_NEVER_MELT_ICE, SPECIES_WEAVILE}},
    [SPECIES_SLUGMA]     = {{EVO_LEVEL, 38, SPECIES_MAGCARGO}},
    [SPECIES_SWINUB]     = {{EVO_LEVEL, 33, SPECIES_PILOSWINE}},
    [SPECIES_PILOSWINE]  = {{EVO_LEVEL, 38, SPECIES_MAMOSWINE}},
    ...
    [SPECIES_SNORUNT]    = {{EVO_LEVEL, 42, SPECIES_GLALIE},
                            {EVO_ITEM, ITEM_NEVER_MELT_ICE, SPECIES_FROSLASS}},
    ...
    [SPECIES_DUSCLOPS]   = {{EVO_LEVEL, 37, SPECIES_DUSKNOIR}},
    [SPECIES_ROSELIA]    = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_ROSERADE}},
