const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_EEVEE]      = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
                            ...
                            {EVO_ITEM, ITEM_STAR_PIECE, SPECIES_SYLVEON}},
    ...
    [SPECIES_UMBREON]    = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
                            ...
                            {EVO_ITEM, ITEM_NEVER_MELT_ICE, SPECIES_GLACEON},
                            {EVO_ITEM, ITEM_STAR_PIECE, SPECIES_SYLVEON}},                        
    [SPECIES_LEAFEON]    = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
                            {EVO_ITEM, ITEM_WATER_STONE, SPECIES_VAPOREON},
                            {EVO_ITEM, ITEM_FIRE_STONE, SPECIES_FLAREON},
                            {EVO_ITEM, ITEM_SUN_STONE, SPECIES_ESPEON},
                            {EVO_ITEM, ITEM_MOON_STONE, SPECIES_UMBREON},
                            {EVO_ITEM, ITEM_NEVER_MELT_ICE, SPECIES_GLACEON},
                            {EVO_ITEM, ITEM_STAR_PIECE, SPECIES_SYLVEON}},
    [SPECIES_GLACEON]    = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
                            {EVO_ITEM, ITEM_WATER_STONE, SPECIES_VAPOREON},
                            {EVO_ITEM, ITEM_FIRE_STONE, SPECIES_FLAREON},
                            {EVO_ITEM, ITEM_SUN_STONE, SPECIES_ESPEON},
                            {EVO_ITEM, ITEM_MOON_STONE, SPECIES_UMBREON},
                            {EVO_ITEM, ITEM_LEAF_STONE, SPECIES_LEAFEON},
                            {EVO_ITEM, ITEM_STAR_PIECE, SPECIES_SYLVEON}},
    [SPECIES_SYLVEON]    = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
                            {EVO_ITEM, ITEM_WATER_STONE, SPECIES_VAPOREON},
                            {EVO_ITEM, ITEM_FIRE_STONE, SPECIES_FLAREON},
                            {EVO_ITEM, ITEM_SUN_STONE, SPECIES_ESPEON},
                            {EVO_ITEM, ITEM_MOON_STONE, SPECIES_UMBREON},
    ...
    [SPECIES_URSARING]   = {{EVO_LEVEL, 42, SPECIES_URSALUNA},
