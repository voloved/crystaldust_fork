...
const u8 gDeoxysPokedexText[] = _(
    ...
    "extraterrestrial virus. Its body is\n"
    "configured for superior agility and speed.");

const u8 gWeavilePokedexText[] = _(
    "They travel in groups of four or\n"
    "five. They bring down their prey\n"
    "with coordinated attacks.");

const u8 gMagnezonePokedexText[] = _(
    "This POKéMON seems to be receiving signals\n"
...
const u8 gTangrowthPokedexText[] = _(
    ...
    "of vines. The POKéMON regenerates quick\n"
...
const u8 gProbopassPokedexText[] = _(
    ...
    "Mini-Noses using magnetic force and\n"
