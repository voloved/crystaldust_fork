...
static const u8 *const sDescriptionStringTable[] =
{
    ...
    [PARTYBOX_DESC_SELECTION_ENTERED] = gText_PartySelectionEntered,
};
...
} static const sCursorOptions[] =
{
    ...
    [MENU_FIELD_MOVES + FIELD_MOVE_WHIRLPOOL] = {gMoveNames[MOVE_WHIRLPOOL], CursorCb_FieldMove},
...
{
    MOVE_FLASH, MOVE_CUT, MOVE_STRENGTH, MOVE_SURF, MOVE_FLY, MOVE_ROCK_SMASH, MOVE_DIVE, MOVE_WATERFALL, MOVE_WHIRLPOOL, MOVE_TELEPORT,
    MOVE_DIG, MOVE_SECRET_POWER, MOVE_MILK_DRINK, MOVE_SOFT_BOILED, MOVE_SWEET_SCENT, MOVE_HEADBUTT, FIELD_MOVE_TERMINATOR
};
...
static const u16 sTMHMMoves[] =
{
    ...
    [ITEM_HM08 - ITEM_TM01] = MOVE_WHIRLPOOL,
    [ITEM_HM09 - ITEM_TM01] = MOVE_DIVE,
};
