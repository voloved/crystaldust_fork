const struct MonCoords gMonFrontPicCoords[] =
{
    ...
    [SPECIES_WEAVILE]     = { .size = 0x66, .y_offset = 4,  },
    [SPECIES_MAGNEZONE]   = { .size = 0x86, .y_offset = 4,  },
    [SPECIES_LICKILICKY]  = { .size = 0x87, .y_offset = 2,  },
    [SPECIES_RHYPERIOR]   = { .size = 0x87, .y_offset = 2,  },
    [SPECIES_TANGROWTH]   = { .size = 0x87, .y_offset = 2,  },
    [SPECIES_ELECTIVIRE]  = { .size = 0x87, .y_offset = 0,  },
    [SPECIES_MAGMORTAR]   = { .size = 0x87, .y_offset = 0,  },
    [SPECIES_TOGEKISS]    = { .size = 0x86, .y_offset = 10, },
    [SPECIES_YANMEGA]     = { .size = 0x86, .y_offset =  5, },
    ...
    [SPECIES_URSALUNA]    = { .size = 0x77, .y_offset =  4, },
    [SPECIES_ANNIHILAPE]  = { .size = 0x87, .y_offset =  0, },
