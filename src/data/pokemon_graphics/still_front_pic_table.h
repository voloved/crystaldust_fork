...
// Gen III
    ...
    SPECIES_SPRITE(LICKILICKY,    gMonStillFrontPic_Lickilicky),
    SPECIES_SPRITE(RHYPERIOR,     gMonStillFrontPic_Rhyperior),
    SPECIES_SPRITE(TANGROWTH,     gMonStillFrontPic_Tangrowth),
    SPECIES_SPRITE(ELECTIVIRE,    gMonStillFrontPic_Electivire),
    ...
    SPECIES_SPRITE(PORYGON_Z,     gMonStillFrontPic_PorygonZ),
    SPECIES_SPRITE(GALLADE,       gMonStillFrontPic_Gallade),
    SPECIES_SPRITE(PROBOPASS,     gMonStillFrontPic_Probopass),
    SPECIES_SPRITE(DUSKNOIR,      gMonStillFrontPic_Dusknoir),
    SPECIES_SPRITE(ROSERADE,      gMonStillFrontPic_Roserade),
    ...
    SPECIES_SPRITE(MISSINGNO,      gMonStillFrontPic_Missingno),
