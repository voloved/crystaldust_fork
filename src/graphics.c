...
const u32 gBagMalePalette[] = INCBIN_U32("graphics/item_menu/bag_male.gbapal.lz");
const u32 gBagFemalePalette[] = INCBIN_U32("graphics/item_menu/bag_female.gbapal.lz");
...
// Pokedex
const u16 gPokedexBgJohto_Pal[] = INCBIN_U16("graphics/pokedex/bg_johto.gbapal");
const u16 gPokedexBgNational_Pal[] = INCBIN_U16("graphics/pokedex/bg_national.gbapal");
const u16 gPokedexCaughtScreenJohto_Pal[] = INCBIN_U16("graphics/pokedex/caught_screen_johto.gbapal");
...
const u32 gPokedexListJohto_Tilemap[] = INCBIN_U32("graphics/pokedex/list_johto.bin.lz");
const u32 gPokedexListNational_Tilemap[] = INCBIN_U32("graphics/pokedex/list_national.bin.lz");
...
const u32 gSetClock_Gfx[] = INCBIN_U32("graphics/wallclock/setclock.4bpp.lz");
const u16 gSetClock_Pal[] = INCBIN_U16("graphics/wallclock/setclock.gbapal");
const u32 gSetClock_Map[] = INCBIN_U32("graphics/wallclock/setclock.bin.lz");
const u32 gPokegear_GridMap[] = INCBIN_U32("graphics/pokegear/background.bin.lz");

const u8 gPhoneCall_WindowGfx[] = INCBIN_U8("graphics/pokegear/phone_call.4bpp");
const u16 gPhoneCall_WindowPal[] = INCBIN_U16("graphics/pokegear/phone_call.gbapal");
const u32 gPhoneCall_IconGfx[] = INCBIN_U32("graphics/pokegear/phone_call_icon.4bpp.lz");
