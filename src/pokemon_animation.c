...
static const u8 sSpeciesToBackAnimSet[] =
{
    ...
    [SPECIES_WEAVILE]    = BACK_ANIM_H_VIBRATE,
    [SPECIES_MAGNEZONE]  = BACK_ANIM_H_VIBRATE,
    [SPECIES_LICKILICKY] = BACK_ANIM_H_VIBRATE,
    [SPECIES_RHYPERIOR]  = BACK_ANIM_H_VIBRATE,
    [SPECIES_TANGROWTH]  = BACK_ANIM_H_VIBRATE,
    [SPECIES_ELECTIVIRE] = BACK_ANIM_H_VIBRATE,
    [SPECIES_MAGMORTAR]  = BACK_ANIM_H_VIBRATE,
    [SPECIES_TOGEKISS]   = BACK_ANIM_H_VIBRATE,
    [SPECIES_YANMEGA]    = BACK_ANIM_H_VIBRATE,
    [SPECIES_GLISCOR]    = BACK_ANIM_H_VIBRATE,
    [SPECIES_MAMOSWINE]  = BACK_ANIM_H_VIBRATE,
    [SPECIES_PORYGON_Z]  = BACK_ANIM_H_VIBRATE,
    [SPECIES_GALLADE]    = BACK_ANIM_H_VIBRATE,
    [SPECIES_PROBOPASS]  = BACK_ANIM_H_VIBRATE,
    [SPECIES_DUSKNOIR]   = BACK_ANIM_H_VIBRATE,
    ...
    [SPECIES_URSALUNA]   = BACK_ANIM_V_SHAKE,
    [SPECIES_ANNIHILAPE] = BACK_ANIM_CONCAVE_ARC_LARGE,
    [SPECIES_LEAFEON]    = BACK_ANIM_H_VIBRATE,
    [SPECIES_GLACEON]    = BACK_ANIM_H_VIBRATE,
    [SPECIES_SYLVEON]    = BACK_ANIM_H_VIBRATE,
    [SPECIES_MISSINGNO]  = BACK_ANIM_V_SHAKE,
};
