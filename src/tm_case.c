...
static void TMCase_ItemPrintFunc(u32 windowId, u16 index, s32 itemId, u8 y);
...
static void Task_SelectTMAction_FromFieldBag(u8 taskId)
{
    ...
    // context menu cursor
    InitMenuInUpperLeftCornerPlaySoundWhenAPressed(sTMCaseDynamicResources->contextMenuWindowId, 2, 0, 1, 16, sTMCaseDynamicResources->numMenuActions, 0);   
