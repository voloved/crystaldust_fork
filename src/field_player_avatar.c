...
static const u16 sPlayerAvatarGfxIds[][2] =
{
    ...
    {OBJ_EVENT_GFX_GOLD_BIKE,           OBJ_EVENT_GFX_KRIS_BIKE},
    {OBJ_EVENT_GFX_ZBRENDAN_ACRO_BIKE,  OBJ_EVENT_GFX_ZMAY_ACRO_BIKE},
    {OBJ_EVENT_GFX_GOLD_SURFING,        OBJ_EVENT_GFX_KRIS_SURFING},
    {OBJ_EVENT_GFX_ZBRENDAN_UNDERWATER, OBJ_EVENT_GFX_ZMAY_UNDERWATER},
    {OBJ_EVENT_GFX_GOLD_FIELD_MOVE,     OBJ_EVENT_GFX_KRIS_FIELD_MOVE},
    {OBJ_EVENT_GFX_GOLD_FISHING,        OBJ_EVENT_GFX_KRIS_FISHING},
    {OBJ_EVENT_GFX_ZBRENDAN_WATERING,   OBJ_EVENT_GFX_ZMAY_WATERING},
};

static const u16 sEmeraldAvatarGfxIds[] = {OBJ_EVENT_GFX_EM_BRENDAN, OBJ_EVENT_GFX_EM_MAY};
...
static const u16 sPlayerAvatarGfxToStateFlag[2][5][2] =
{
    [MALE] =
    {
        ...
        {OBJ_EVENT_GFX_GOLD_BIKE,  PLAYER_AVATAR_FLAG_BIKE},
        {OBJ_EVENT_GFX_ZBRENDAN_ACRO_BIKE,  PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_GOLD_SURFING,    PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_ZBRENDAN_UNDERWATER, PLAYER_AVATAR_FLAG_UNDERWATER},
    },
    [FEMALE] =
    {
        {OBJ_EVENT_GFX_KRIS_NORMAL,         PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_KRIS_BIKE,      PLAYER_AVATAR_FLAG_BIKE},
        {OBJ_EVENT_GFX_ZMAY_ACRO_BIKE,      PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_KRIS_SURFING,        PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_ZMAY_UNDERWATER,     PLAYER_AVATAR_FLAG_UNDERWATER},
    }
};
...
static void PlayerNotOnBikeMoving(u8 direction, u16 heldKeys)
{
    ...
    && (gRunToggleBtnSet || (FlagGet(FLAG_ALLOW_RUNNING_TOGGLE) && FlagGet(FLAG_RUNNING_SHOES_TOGGLE)) || (heldKeys & B_BUTTON))
...
static bool8 TryPushBoulder(s16 x, s16 y, u8 direction)
{
    if (FlagGet(FLAG_SYS_USE_STRENGTH))
    {
        ...
        if (objectEventId != OBJECT_EVENTS_COUNT && gObjectEvents[objectEventId].graphicsId == OBJ_EVENT_GFX_PUSHABLE_BOULDER)
        {
            ...
            MoveCoords(direction, &x, &y);
            if (MapGridGetMetatileBehaviorAt(x, y) == MB_MT_PYRE_HOLE || (GetCollisionAtCoords(&gObjectEvents[objectEventId], x, y, direction) == COLLISION_NONE
...
u8 GetPlayerAvatarGenderByGraphicsId(u16 gfxId)
{
    ...
    case OBJ_EVENT_GFX_KRIS_BIKE:
    case OBJ_EVENT_GFX_ZMAY_ACRO_BIKE:
    case OBJ_EVENT_GFX_KRIS_SURFING:
    case OBJ_EVENT_GFX_KRIS_FIELD_MOVE:
    case OBJ_EVENT_GFX_ZMAY_UNDERWATER:
    case OBJ_EVENT_GFX_KRIS_FISHING:
    case OBJ_EVENT_GFX_ZMAY_WATERING:
        return FEMALE;
    default:
        return MALE;
    }
...
static bool8 Fishing_ShowDots(struct Task *task)
{
    ...
    if (++task->tFrameCounter >= 20)
    {
        ...
        {
            AddTextPrinterParameterized(0, 2, dot, task->tNumDots * 8, 1, 0, NULL);
            task->tNumDots++;
        }
    }
    return FALSE;
