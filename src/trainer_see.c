...
static const struct SpriteFrameImage sSpriteImageTable_ExclamationQuestionMark[] =
{
    ...
    {
        .data = sEmotion_ExclamationMarkGfx + 0x80,
        .size = 0x80
    },
    {
        .data = sEmotion_ExclamationMarkGfx + 0x100,
        .size = 0x80
    },
    {
    ...
    {
        .data = sEmotion_QuestionMarkGfx + 0x80,
        .size = 0x80
    },
    {
        .data = sEmotion_QuestionMarkGfx + 0x100,
        .size = 0x80
    }
};
