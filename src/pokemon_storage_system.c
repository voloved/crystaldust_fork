...
static void Task_PCMainMenu(u8 taskId)
{
    ...
    case STATE_LOAD:
        ...
        AddTextPrinterParameterized2(0, 2, sMainMenuTexts[task->tSelectedOption].desc, TEXT_SPEED_FF, NULL, 2, 1, 3);
...
static u8 GetBoxStatusFromStatus(struct Pokemon *mon)
{
    ...
    if (ailment > 7)  //to fit into the 3 bit box_ailment
        ailment = 0;
    return ailment;
}
...
} static const sRestrictedReleaseMoves[] =
{
    ...
    {MAP_GROUPS_COUNT, 0, MOVE_STRENGTH},
    {MAP_GROUPS_COUNT, 0, MOVE_ROCK_SMASH},
    {MAP_GROUPS_COUNT, 0, MOVE_STRENGTH},
    {MAP_GROUPS_COUNT, 0, MOVE_ROCK_SMASH},
};
