...
const u8 gText_MainMenuMysteryGift2[] = _("MYSTERY GIFT-e");
const u8 gText_MainMenuMysteryEvents[] = _("MYSTERY EVENT");
...
const u8 gText_MysteryGiftCantUse[] = _("MYSTERY GIFT-e can't be used while\nthe Wireless Adapter is attached.");
const u8 gText_MysteryEventsCantUse[] = _("MYSTERY EVENT can't be used while\nthe Wireless Adapter is attached.");
...
const u8 gText_OakBoy[] = _("BOY");
const u8 gText_OakGirl[] = _("GIRL");
...
const u8 gText_PokedexInfo[] = _("POKéMON INFO");
...
const u8 gText_NoPokemon[] = _("You have no\nPOKéMON.");
...
const u8 gText_CantStoreImportantItems[] = _("Important items can't\nbe stored in the PC!");
...
const u8 gText_PokeDollTurnOn[] = _("Turned on Poké Doll.\nTrainers will now ignore you.{PAUSE_UNTIL_PRESS}");
const u8 gText_PokeDollTurnOff[] = _("Turned off Poké Doll.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_InBagVar1[] = _("IN BAG:{FONT SMALL} {STR_VAR_1}");
...
const u8 gText_BoughtItemAlready[] = _("You bought that already.\nI'm all sold out of it.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ThrowInExtraPokeBall[] = _("I'll throw in an extra POKé BALL, too.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_AbandonBugCatchingContest[] = _("Abandon the Bug-Catching Contest?");
...
const u8 gText_EggWillHatchSoon[] = _("It occasionally\nmoves. It should\nhatch soon.");
...
const u8 gText_WithdrawItem2[] = _("WITHDRAW\nITEM");
...
const u8 gText_SpecialMenu[] = _("SPECIAL MENU");
...
const u8 gText_LinkCableBattles[] = _("LINK CABLE BATTLES  W/            L/");
...
const u8 gText_ButtonTypeLEqualsA[] = _("L/R=TurboA/B");
const u8 gText_ButtonTypeVSnycToggle[] = _("L=VSync");
...
const u8 gText_SetClock_InTheAfternoon[] = _("in the afternoon");
const u8 gText_SetClock_InTheEvening[] = _("in the evening");
const u8 gText_SetClock_AtNight[] = _("at night");
const u8 gText_SetClock_Midnight[] = _("It's midnight");
const u8 gText_SetClock_Noon[] = _("It's noon");
...
// Pokégear
const u8 gText_PokegearInstructions[] = _("Press {L_BUTTON} and {R_BUTTON} to switch.\nPress B to exit.");
...
const u8 gText_ClockCardHelp[] = _("{SELECT_BUTTON}RESET  {A_BUTTON}MODE  {B_BUTTON}EXIT");
